...
def load_array(filename):
    """
    Carica un array NumPy dalla directory:
...
def convert_history_to_json(
    history,
):
    """
    Converte i valori dello storico Keras
    in normali float Python.

    Questo garantisce che possano essere
    salvati correttamente in formato JSON.
    """
...
def main():
    ...
    x_train_clean = load_array(
        "x_train_clean.npy"
    )

    x_train_noisy = load_array(
        "x_train_noisy.npy"
    )

    x_validation_clean = load_array(
        "x_validation_clean.npy"
    )

    x_validation_noisy = load_array(
    ...
    print(
        "Validation pulito:",
        x_validation_clean.shape,
    )

    print(
        "Validation rumoroso:",
        x_validation_noisy.shape,
    )
    ...
    model.compile(
        ...
        # Il modello deve minimizzare
        # la distanza quadratica tra:
        #
        # immagine pulita
        #
        # e:
    ...
    history = model.fit(
        ...
        # Validation:
        # input rumoroso e target pulito
